<div>
    @if (Gate::check('addTeamMember', $group))
            ...
            <x-jet-form-section submit="addTeamMember">
                ...
                <x-slot name="form">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-select2 id="email" type="email" class="mt-1 block w-full"
                            wire:model.defer="addTeamMemberForm.email" multiple>
    ...
    @if ($group->teamInvitations->isNotEmpty() && Gate::check('addTeamMember', $group))
        <x-jet-section-border />
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-action-section>
                ...
                <x-slot name="content">
                    <div class="space-y-6">
                        @foreach ($group->teamInvitations as $invitation)
                            <div class="flex items-center justify-between">
                                <div class="text-gray-600">{{ $invitation->email }}</div>

                                <div class="flex items-center">
                                    @if (Gate::check('removeTeamMember', $group))
    ...
    @if ($group->users->isNotEmpty())
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-action-section>
                ...
                <x-slot name="content">
                    <div class="space-y-6">
                        @foreach ($group->users->sortBy('name') as $user)
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                ...
                                <div class="flex items-center">
                                    ...
                                    @if (Gate::check('addTeamMember', $group) && Laravel\Jetstream\Jetstream::hasRoles())
                                    ...
                                    @if ($this->user->id === $user->id)
                                        ...
                                        <!-- Remove Team Member -->
                                    @elseif (Gate::check('removeTeamMember', $group))
                                        <button class="cursor-pointer ml-6 text-sm text-red-500"

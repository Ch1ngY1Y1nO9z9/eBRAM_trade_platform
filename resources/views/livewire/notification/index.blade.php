                                ...
                                <tr class="py-2">
                                    ...
                                    @if (auth()->user()->role == 'buyer')
                                        <td>
                                            {{ auth()->user()->findUser($item->seller_id)->name }}
                                             @if($item->status == 'unread')(New!)@endif
                                        </td>
                                    ...
                                    <td>
                                        <div class="flex justify-center">
                                            <button
                                                class="bg-green-700 hover:bg-green-500 text-white font-bold py-2 px-4 rounded mr-3"
                                                >Detail</button>
                                            <a class="bg-blue-700 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded mr-3"
                                                href="/team/{{ auth()->user()->countTeam() + 1 }}">Accept</a>
                                            <button

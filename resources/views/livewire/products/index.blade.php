    ...
    <div class="flex flex-col x-auto py-10 sm:px-6 lg:px-8" x-data="{ open: true }">
        <div class="flex flex-wrap py-5 flex-col md:flex-row items-center">
            <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                <span class="text-xl">Current Products</span>
            </a>
            <nav
        ...
        <div x-show="open" class="overflow-x-auto">
            <div class="align-middle inline-block min-w-full">
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg bg-white sm:px-6 lg:px-8">
                            ...
                            <tr class="py-2">
                                ...
                                <td>
                                    <div class="flex min-w-[150px]">
                                        <a class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded mr-3"
                                        href="/RFQ/detail/1">詳細</a>
                                        <a class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded"
                                            href="#" target="_blank">取消</a>

            ...
            <div class="container px-5 py-24 mx-auto">
              <div class="flex flex-wrap -mx-4 -mb-10 text-center">
                <div class="sm:w-1/2 mb-10 px-4">
                  ...
                  <a href="{{ route('register') }}" class="block mx-auto mt-6 text-white bg-indigo-500 border-0 py-2 px-5 focus:outline-none hover:bg-indigo-600 rounded">Be a Buyer</a>
                </div>
                <div class="sm:w-1/2 mb-10 px-4">
                  <div class="rounded-lg h-64 overflow-hidden">
                  ...
                  <p class="leading-relaxed text-base">Lorem ipsum dolor sit amet consectetur adipisicing elit. Est, tempore repellat veniam obcaecati atque recusandae exercitationem similique, aperiam voluptas minima aspernatur magnam quod quibusdam porro nisi suscipit. Nemo, quidem similique?</p>
                  <a href="{{ route('register') }}" class="block mx-auto mt-6 text-white bg-indigo-500 border-0 py-2 px-5 focus:outline-none hover:bg-indigo-600 rounded">Be a Seller</a>
                </div>
              </div>
            </div>
          </section>
